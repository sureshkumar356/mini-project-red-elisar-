...
**Generated:** 2026-04-28T05:24:30.578647+00:00
...
- **Technique ID:** `T1550`
- **Tactic:** credential-access
- **Description:** Use alternate authentication material, such as stolen credentials, to access additional accounts on the network.
- **Rationale:** 
- **Prerequisites:** 
- **Detection:** 
- **Mitigation:** General Best Practices: Apply defense-in-depth principles: network segmentation, least-privilege access, endpoint detection and response (EDR), security awareness training, regular patching, and monitoring.
...
- **Technique ID:** `T1199`
- **Tactic:** persistence
- **Description:** Maintain the trusted relationship with the contractor or business partner to ensure continued access to the network.
- **Rationale:** 
- **Prerequisites:** 
- **Detection:** 
- **Mitigation:** General Best Practices: Apply defense-in-depth principles: network segmentation, least-privilege access, endpoint detection and response (EDR), security awareness training, regular patching, and monitoring.
...
- **Technique ID:** `T1649`
- **Tactic:** persistence
- **Description:** Regularly update and maintain the stolen authentication certificates to ensure continued access to the network.
- **Rationale:** 
- **Prerequisites:** 
- **Detection:** 
- **Mitigation:** General Best Practices: Apply defense-in-depth principles: network segmentation, least-privilege access, endpoint detection and response (EDR), security awareness training, regular patching, and monitoring.
...
- **Technique ID:** `T1078`
- **Tactic:** persistence
- **Description:** Monitor and maintain access to the valid accounts to ensure continued access to the network.
- **Rationale:** 
- **Prerequisites:** 
- **Detection:** 
- **Mitigation:** Multi-factor Authentication: Enforce MFA for all remote access and privileged accounts. Monitor for anomalous login patterns, impossible travel, and credential stuffing.
...
- **Total Pipeline Latency:** 8.16s
- **Retrieval Latency:** 7022ms
- **LLM Generation Latency:** 1.09s
- **Tokens/Second:** 1052.6
